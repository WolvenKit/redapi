...
export const MessageComparison: MessageComparisonResolvers = {
  ...
  Duplicate: async (_parent, _arg, _ctx) => {
    /* MessageComparison.Duplicate resolver is required because MessageComparison.Duplicate exists but MessageComparisonMapper.Duplicate does not */
